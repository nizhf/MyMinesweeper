...
DialogWin::DialogWin(int left, int right, int doubleClick, int timeInMsec, int mousePath) :
...
void DialogWin::initLayout() {
    ...
    connect(btnOk, &QPushButton::clicked, this, &DialogWin::reject);
    ...
    layoutDialog->addWidget(btnOk, 4, 3, 1, 1);
}
